...
var G__13420 = o;
goog.object.set(G__13420,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13421__delegate = function (args){
...
while (G__13422__i < G__13422__a.length) {G__13422__a[G__13422__i] = arguments[G__13422__i + 0]; ++G__13422__i;}
  args = new cljs.core.IndexedSeq(G__13422__a,0,null);
} 
return G__13421__delegate.call(this,args);};
...
return G__13421__delegate(args);
});
...
var G__13424 = o;
goog.object.set(G__13424,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__13428 = props;
var G__13428__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13428,cljs.core.cst$kw$id,id):G__13428);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13428__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__13429 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13429,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__13429;
}
})(),id_class);
...
var G__13430 = (cljs.core.count(argv) - first_child);
switch (G__13430) {
case (0):
...
break;
case (1):
var G__13431 = component;
var G__13432 = jsprops;
var G__13433 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__13431,G__13432,G__13433);
...
var vec__13435 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13435,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13435,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13435,(2),null);
...
var temp__5739__auto___13438 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___13438 == null)){
} else {
var key_13439 = temp__5739__auto___13438;
(jsprops.key = key_13439);
}
...
var temp__5739__auto___13442 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___13442 == null)){
} else {
var key_13443 = temp__5739__auto___13442;
(jsprops.key = key_13443);
}

var G__13440 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__13441 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__13440,G__13441);
});
/**
...
var temp__5739__auto___13444 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___13444 == null)){
} else {
var key_13445 = temp__5739__auto___13444;
(jsprops.key = key_13445);
}
...
var temp__5739__auto___13446 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___13446 == null)){
} else {
var key_13447 = temp__5739__auto___13446;
(jsprops.key = key_13447);
}
...
var temp__5739__auto___13448 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___13448 == null)){
} else {
var key_13449 = temp__5739__auto___13448;
(jsprops.key = key_13449);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13450_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__13450_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13451 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13451,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13451,(1),null);
...
break;
default:
var G__13456 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__13457 = compiler;
v = G__13456;
compiler = G__13457;
continue;
...
var G__13458 = tag;
var G__13458__$1 = (((G__13458 instanceof cljs.core.Keyword))?G__13458.fqn:null);
switch (G__13458__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template13461 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template13461 = (function (opts,id,fn_to_element,meta13462){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template13461.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13463,meta13462__$1){
var self__ = this;
var _13463__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13461(self__.opts,self__.id,self__.fn_to_element,meta13462__$1));
}));

(reagent.impl.template.t_reagent$impl$template13461.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13463){
var self__ = this;
var _13463__$1 = this;
return self__.meta13462;
}));

(reagent.impl.template.t_reagent$impl$template13461.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13461.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13461.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13461.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13461.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta13462], null);
}));

(reagent.impl.template.t_reagent$impl$template13461.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13461.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13461");

(reagent.impl.template.t_reagent$impl$template13461.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template13461");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13461.
 */
reagent.impl.template.__GT_t_reagent$impl$template13461 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template13461(opts__$1,id__$1,fn_to_element__$1,meta13462){
return (new reagent.impl.template.t_reagent$impl$template13461(opts__$1,id__$1,fn_to_element__$1,meta13462));
});

}

return (new reagent.impl.template.t_reagent$impl$template13461(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
